...
EN_cardError_t getCardHolderName(ST_cardData_t* cardData)
{
	...
	gets(name);                    /* i used gets() instead of fgets and put the string in the buffer called name 
...
EN_cardError_t getCardExpiryDate(ST_cardData_t* cardData)
{
	...
	gets(exp_date);                                /* i used gets() instead of fgets and put the string in the buffer called exp_date 
								                    and then check about the lenght
